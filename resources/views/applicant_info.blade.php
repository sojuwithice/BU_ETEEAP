...
<div class="header">
                ...
                <div class="step-list">
                    ...
                    <div class="step-item" onclick="toggleStep(this, event)">
                        ...
                        <div class="step-content">
                            ...
                            <div class="step-details">
                                <p>{{ $applicant->interview_date ? 'Scheduled: ' . date('F d, Y', strtotime($applicant->interview_date)) : 'No interview scheduled yet.' }}</p>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="modal-right">
                    ...
                    <button class="btn-set" onclick="saveInterviewSchedule()">Set</button>
                </div>
            </div>
        </div>
    </div>

    <div id="toast" class="toast" style="display: none; position: fixed; bottom: 20px; right: 20px; background: #25c14a; color: white; padding: 12px 20px; border-radius: 8px; z-index: 10000;">
    ...
    function showToast(message, type = 'success') {
        ...
        toast.style.backgroundColor = type === 'success' ? '#25c14a' : '#e03d4d';
    ...
    function toggleModal() { 
        document.getElementById('addRequirementModal')?.classList.toggle('show'); 
    }
    ...
    function saveInterviewSchedule() {
        ...
        const date = `${currentMonth + 1}/${selectedDay}/${currentYear}`;
        const hour = document.getElementById('hourInput')?.value || '09';
        const minute = document.getElementById('minuteInput')?.value || '00';
        ...
        .catch(error => showToast("Error setting interview", "error"));
    }
